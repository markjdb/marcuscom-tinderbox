# $MCom: portstools/tinderbox/Makefile,v 1.58.2.41 2012/10/27 18:32:21 marcus Exp $
...
MIGDATA=	build_ports.map build_ports_queue.map builds.map config.map \
		...
		mig_mysql_tinderbox-3.1_to_3.2.sql \
		mig_pgsql_tinderbox-3.1_to_3.2.sql \
		mig_mysql_tinderbox-3.2_to_3.2.1.sql \
		mig_pgsql_tinderbox-3.2_to_3.2.1.sql \
		mig_mysql_tinderbox-3.2.1_to_3.2.2.sql \
		mig_pgsql_tinderbox-3.2.1_to_3.2.2.sql \
		mig_mysql_tinderbox-3.2.2_to_3.2.3.sql \
		mig_pgsql_tinderbox-3.2.2_to_3.2.3.sql \
		mig_mysql_tinderbox-3.2.3_to_3.2.4.sql \
		mig_pgsql_tinderbox-3.2.3_to_3.2.4.sql \
		mig_mysql_tinderbox-3.2.4_to_3.2.5.sql \
		mig_pgsql_tinderbox-3.2.4_to_3.2.5.sql \
		mig_mysql_tinderbox-3.2.5_to_3.2.6.sql \
		mig_pgsql_tinderbox-3.2.5_to_3.2.6.sql \
		mig_mysql_tinderbox-3.2.6_to_3.3.sql \
		...
		mig_mysql_tinderbox-3.4_to_3.4.1.sql \
		mig_pgsql_tinderbox-3.4_to_3.4.1.sql \
		mig_mysql_tinderbox-3.4.1_to_3.4.2.sql \
		mig_pgsql_tinderbox-3.4.1_to_3.4.2.sql
