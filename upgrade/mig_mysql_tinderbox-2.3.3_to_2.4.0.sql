...
ALTER TABLE build_ports ADD Last_Failed_Dependency varchar(255);
ALTER TABLE build_ports MODIFY COLUMN Last_Status enum('UNKNOWN','SUCCESS','FAIL','BROKEN','LEFTOVERS','DUD','DEPEND') DEFAULT 'UNKNOWN';

ALTER TABLE build_ports ADD Last_Run_Duration int;
ALTER TABLE build_ports ADD Currently_Building tinyint(1)  NOT NULL default '0';
